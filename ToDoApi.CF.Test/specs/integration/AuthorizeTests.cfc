		...
		describe( "Test Authentication", function(){
            ...
            describe( "POST /login", function(){
				...
				it( "should authenticate a user with valid credentials", function(){
					...
					expect(	response.getData() ).toHaveKey( "accessToken" );
					expect(	response.getData() ).toHaveKey( "expiresIn" );
					
				});


				xit( "should issue an auth cookie on successful authentication", function(){
					...
					expect( jwt.decode( token ).sub ).toBe( "test@example.com" );
				...
				xit( "should allow access with a valid authentication cookie", function(){
